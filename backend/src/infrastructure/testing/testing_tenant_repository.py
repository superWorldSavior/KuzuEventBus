"""Testing implementation of CustomerAccountRepository (in-memory)."""
...
from src.domain.shared.value_objects import TenantName
from src.domain.tenant_management.customer_account import CustomerAccount


class TestingTenantRepository(CustomerAccountRepository):
    ...
    async def find_by_tenant_name(self, tenant_name: Union[TenantName, str]) -> Optional[CustomerAccount]:
