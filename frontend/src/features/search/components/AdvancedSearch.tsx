...
import { SearchFilter, SavedSearch } from "../stores/search";
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-4">
          {recentSearches.length > 0 && (
            <div>
              ...
              <div className="space-y-1">
                {recentSearches.slice(0, 5).map((recentQuery: string, index: number) => (
                  <button
                    key={index}
          ...
          {savedSearches.length > 0 && (
            <div>
              ...
              <div className="space-y-1">
                {savedSearches.slice(0, 5).map((savedSearch: SavedSearch) => (
                  <button
                    key={savedSearch.id}
