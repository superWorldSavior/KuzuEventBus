...
export const CypherEditor = lazyWithRetry(
  () => import('@/features/query-execution/components/CypherEditor').then(m => ({ default: m.CypherEditor })),
  'CypherEditor'
);

export const NetworkDiagram = lazyWithRetry(
  () => import('@/widgets/visualizations/NetworkDiagram').then(m => ({ default: m.NetworkDiagram })),
  'NetworkDiagram'
);

export const QueryCanvas = lazyWithRetry(
  () => import('@/features/query-execution/components/query-builder/QueryCanvas').then(m => ({ default: m.QueryCanvas })),
  'QueryCanvas'
);

export const AdvancedSearch = lazyWithRetry(
  () => import('@/features/search/components/AdvancedSearch').then(m => ({ default: m.AdvancedSearch })),
  'AdvancedSearch'
);
...
export function usePreloadComponents() {
  ...
  const preloadComponents = () => {
    ...
    preloadComponent(() => import('@/features/query-execution/components/CypherEditor'));
    preloadComponent(() => import('@/widgets/visualizations/NetworkDiagram'));
  };
